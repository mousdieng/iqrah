...
export default function VerseCard({
                                      ...
                                      fontSize,
                                      individualRepeatMode = false,
                                      individualRepeatCount = 1,
      ...
      `}
        ...
        <span className="text-amber-300 text-sm flex items-center gap-2">
            ...
            {individualRepeatMode && (
                <span className="text-orange-400 text-xs">🔁{individualRepeatCount}x</span>
            )}
            {pageRepeatMode && (
            ...
            {showRepeatInfo && (
              ...
              ({currentRepeatCount + 1}/{individualRepeatMode ? individualRepeatCount : pageRepeatCount})
                ...
                <div className="flex gap-2">
                    ...
                    >
                        {isPlaying ? '⏸️' : individualRepeatMode ? '🔁' : '▶️'}
                    </button>
                    {isSelectionMode && (
                        <button
                            onClick={(e) => {
